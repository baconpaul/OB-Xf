...
class MPEMatrixEditor : public juce::Component
{
  public:
    ...
    void paint(juce::Graphics &g) override
    {
        ...
        g.drawText(
            "MPE support is alpha.  Changes here may not be compatible with 1.1 release.",
    ...
    static int preferredWidth() { return kPad + kSourceW + kColGap + kTargetW + kColGap + kDepthW + kPad; }
    static int preferredHeight()
    {
        return rowY(numMatrixRows - 1) + kRowH + kPad;
    }
  ...
  private:
    ...
    static constexpr int kColHeaderY =
        kPad + kTitleH + kTitleGap + kWarningH + kWarningGap;
