...
class OBXdImporter
{
  public:
    struct Options
    {
        // Compensate for OB-Xf's corrected envelope-attack scaling so that
        // imported patches sound (rather than measure) the same as in OB-Xd.
        // See OBXd-Importer-Plan.md §2.5.
        bool envAttackCompat;

        Options() : envAttackCompat(true) {}
    };
